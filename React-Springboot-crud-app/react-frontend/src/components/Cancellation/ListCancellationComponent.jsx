...
class ListCancellationComponent extends Component {
    constructor(props) {
        super(props)
        this.state={
        passengerrs: []
    ...
    deletePassengerr(pid){
        CancellationService.deletePassengerr(pid).then(res=>{
    ...
    componentDidMount(){
        CancellationService.getPassengers().then((res)=>{
...
export default (ListCancellationComponent);
