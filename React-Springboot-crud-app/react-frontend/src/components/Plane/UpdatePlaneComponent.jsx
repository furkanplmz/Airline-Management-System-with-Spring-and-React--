...
export default class UpdatePlaneComponent extends Component {
  constructor(props) {
    super(props);
...
componentDidMount(){
    PlaneService.getPassengerrById(this.state.pid).then( (res) =>{
...
updatePassengerr=(e)=>{
    ...
    PlaneService.updatePassengerr(passengerr,this.state.pid).then(res=>{
