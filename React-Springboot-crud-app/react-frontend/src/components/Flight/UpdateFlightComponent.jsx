...
export default class UpdateFlightComponent extends Component {
  constructor(props) {
    super(props);
...
componentDidMount(){
    FlightsService.getPassengerrById(this.state.pid).then( (res) =>{
...
updatePassengerr=(e)=>{
    ...
    FlightsService.updatePassengerr(passengerr,this.state.pid).then(res=>{
