...
import PassengerrService from '../Passenger/PassengerrService';


export default class UpdatePassengerComponent extends Component {
  constructor(props) {
    super(props);
    ...
    this.updatePassengerr=this.updatePassengerr.bind(this);
}

componentDidMount(){
    PassengerrService.getPassengerrById(this.state.pid).then( (res) =>{
    let passengerr=res.data;
    this.setState({
      pname: passengerr.pname,
      last: passengerr.last,
      pnat: passengerr.pnat,
      pgen: passengerr.pgen,
      ppass: passengerr.ppass,
      padd: passengerr.padd,
      pphone: passengerr.pphone
    });
  });
}
...
updatePassengerr=(e)=>{
    ...
    PassengerrService.updatePassengerr(passengerr,this.state.pid).then(res=>{
            ...
            <div className='container'>
                <div className='row'>
                    <div className='card col-md-6 offset-md-3 offset-md-3'>
                        <h3 className='text-center'>Yolcu Güncelle</h3>
                        <div className='card-body'>
                            <form>
                                ...
                                <button className='btn btn-success'onClick={this.updatePassengerr}>Kaydet</button>
                            </form>
                        </div>
                    </div>
                </div>
