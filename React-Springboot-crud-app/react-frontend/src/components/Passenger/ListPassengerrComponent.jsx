...
import CreatePassengerComponent from './CreatePassengerComponent';
...
class ListPassengerrComponent extends Component {
    constructor(props) {
        super(props)
        this.state={
        passengerrs: []
    ...
    deletePassengerr(pid){
        PassengerrService.deletePassengerr(pid).then(res=>{
    ...
    componentDidMount(){
        PassengerrService.getPassengers().then((res)=>{
...
export default (ListPassengerrComponent);
