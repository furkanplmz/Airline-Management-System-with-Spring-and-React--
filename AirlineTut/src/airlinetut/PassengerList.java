...
public class PassengerList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Uçuş Listesi");

        PassengerListTable.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        PassengerListTable.setRowHeight(25);
        PassengerListTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                PassengerListTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(PassengerListTable);
    ...
    private void PassengerListTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PassengerListTableMouseClicked
        
        
    }//GEN-LAST:event_PassengerListTableMouseClicked
    ...
    private void FTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FTableMouseClicked
         ...
         Rs=St.executeQuery("SELECT tickettbl.PName,tickettbl.PLastName,tickettbl.PGen,tickettbl.PPass"
                 + " from tickettbl INNER JOIN flighttbl on tickettbl.FlCode=flighttbl.FlCode where TicketTbl.FlCode='"+ Key +"'");
         PassengerListTable.setModel(DbUtils.resultSetToTableModel(Rs));    
     } 
        catch (Exception e) {
     }     
